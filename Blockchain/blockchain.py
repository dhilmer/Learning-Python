...
class Blockchain:
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            if block['previous_hash'] != self.hash(last.block):
                return False
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        :param previous_hash: (Opitonal) <str> Hash of previous Block
    ...
    def hash(block):
        """
        Creates a SHA-156 hash of a Block
...
def mine():
    # We reun the proof of work algorithm to get the next proof...
